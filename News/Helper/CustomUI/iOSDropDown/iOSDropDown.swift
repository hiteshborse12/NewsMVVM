...
open class DropDown: UITextField {
    ...
    public func showList() {
        ...
        table = UITableView(frame: CGRect(x: pointToParent.x,
                                          ...
                                          width: frame.width,
                                          height: frame.height))
        table.accessibilityIdentifier = self.cellAccessibilityIdentifier
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell_accessibilityIdentifier = "\(cellAccessibilityIdentifier ?? "")_\(indexPath.row)"
        ...
        cell?.accessibilityIdentifier = cell_accessibilityIdentifier
        return cell!
    }
}
